...
public class CourtContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;
    public CourtContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.COURT_CONTAINER.get(), windowId);
