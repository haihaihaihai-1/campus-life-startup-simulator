...
public class GrantContainer extends Container {
    protected final PlayerInventory playerInv;
    protected final BlockPos pos;

    public GrantContainer(int id, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.GRANT_CONTAINER.get(), id);
        this.playerInv = inv;
        this.pos = pos;
    }
