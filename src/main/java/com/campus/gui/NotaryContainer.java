...
public class NotaryContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;
    public NotaryContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.NOTARY_CONTAINER.get(), windowId);
