...
public class TrophyContainer extends Container {
    protected final PlayerInventory playerInv;
    protected final BlockPos pos;

    public TrophyContainer(int id, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.TROPHY_CONTAINER.get(), id);
        this.playerInv = inv;
        this.pos = pos;
    }
