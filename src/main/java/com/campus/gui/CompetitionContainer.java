...
public class CompetitionContainer extends Container {
    protected final PlayerInventory playerInv;
    protected final BlockPos pos;

    public CompetitionContainer(int id, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.COMPETITION_CONTAINER.get(), id);
        this.playerInv = inv;
        this.pos = pos;
    }
