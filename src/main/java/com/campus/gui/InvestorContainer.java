...
public class InvestorContainer extends Container {
    protected final PlayerInventory playerInv;
    protected final BlockPos pos;

    public InvestorContainer(int id, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.INVESTOR_CONTAINER.get(), id);
        this.playerInv = inv;
        this.pos = pos;
    }
