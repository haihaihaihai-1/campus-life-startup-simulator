...
public class TrainingContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;
    public TrainingContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.TRAINING_CONTAINER.get(), windowId);
