...
public class TalentContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;
    public TalentContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.TALENT_CONTAINER.get(), windowId);
