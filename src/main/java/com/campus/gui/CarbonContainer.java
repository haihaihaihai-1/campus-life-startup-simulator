...
public class CarbonContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;
    public CarbonContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.CARBON_CONTAINER.get(), windowId);
