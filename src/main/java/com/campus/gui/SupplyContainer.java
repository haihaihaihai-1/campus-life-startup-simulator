...
public class SupplyContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;
    public SupplyContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.SUPPLY_CONTAINER.get(), windowId);
