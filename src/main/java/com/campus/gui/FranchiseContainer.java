...
public class FranchiseContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;
    public FranchiseContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.FRANCHISE_CONTAINER.get(), windowId);
