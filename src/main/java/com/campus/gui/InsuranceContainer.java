...
public class InsuranceContainer extends Container {
    private final int playerMoney;
    private final UUID playerUUID;

    public InsuranceContainer(int windowId, PlayerInventory inv, BlockPos pos) {
        super(CampusContainers.INSURANCE_CONTAINER.get(), windowId);
    ...
    public void handleBuy(PlayerEntity p, int idx) {
        if (p instanceof ServerPlayerEntity) InsuranceSystem.buy((ServerPlayerEntity) p, idx);
    }
}
