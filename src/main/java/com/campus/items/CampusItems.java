...
public class CampusItems {
    ...
    public static final RegistryObject<Item> REPORT_CARD =
            ITEMS.register("report_card", () -> new Item(new Item.Properties()
                    .tab(CampusItemGroup.INSTANCE).stacksTo(1)));
